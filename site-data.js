...
window.SITE_DATA.semantics={
  ...
  education:{
    ...
    courseEvidence:[
      {id:"bsc-logic-core",title:"Logic & metalogic",programmeId:"charles-university",status:"completed",courses:["Propositional and Predicate Logic I","Propositional and Predicate Logic II","Introduction to Mathematical Logic","Properties of Axiomatic Theories","Modal and Non-classical Logics","Dynamic Logic","Incompleteness and Gödel's Theorems","Logic in Contexts and Applications","Methods in Philosophical Logic","Readings on Material Inference","Seminar: Trends in Metalogic","Conditionals: Logic, Probability, and New Perspectives","History of Logic","History of Modern Mathematics and Logic","Foundations of Modern Mathematics"],supportsKnowledgeIds:["mathematical-logic","first-order-logic","model-theory","modal-logic","dynamic-logic","incompleteness"]},
      {id:"bsc-mathematics",title:"Mathematics & algebra",programmeId:"charles-university",status:"completed",courses:["Seminar in Mathematics","Introduction to Mathematics","Set Theory I","Arithmetic and Algorithms","Algebra and Structures in Logic","Selected Topics in Mathematics","Number Theory Seminar","Mathematical Problems for Non-mathematicians"],supportsKnowledgeIds:["set-theory","number-theory","universal-algebra","lattice-theory"]},
      ...
      {id:"bsc-ai-philosophy",title:"AI & philosophy",programmeId:"charles-university",status:"completed",courses:["AI in Context","Elements of AI+","Ethics of AI+","AI and Philosophy","Can Machines Think?","AI and Cognition","Philosophical Aspects of Logic and Mathematics","Analytic Philosophy I","Analytic Philosophy II","What Cannot Be Spoken About"],supportsKnowledgeIds:["ai-methods","philosophy-ai"]}
    ],
    prgAiBlocks:[
