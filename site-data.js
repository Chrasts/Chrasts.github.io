...
window.SITE_DATA={
  ...
  N("student-ball","experience","Student Ball","experience","experience/student-ball",null,"Two-person event project covering budgeting, coordination and operations.",{"meta":"2020 - 2021","timelineOrder":2,"role":"Event Co-lead","organisation":"Self-organised project - Two-person team","highlights":["Budgeting and cash-flow planning","Event coordination and logistics","Transaction reconciliation"]}),
  ...
  N("esslli","education","ESSLLI 2026","education","education/esslli",null,"Intensive courses touching algebraic/logical methods, language models, logic for AI and SAT/SMT solving.",{"meta":"2026","layoutOrder":5,"programme":"Participant & volunteer","organisation":"ESSLLI","highlights":["Stone duality","Logic and language models","Logic for AI and SAT/SMT"]}),
  N("prg-ai","education","prg.ai Minor","education","education/prg-ai","ongoing","Inter-university AI programme combining cross-faculty coursework with industry talks and a broader AI community.",{"meta":"2026 - present","layoutOrder":3,"programme":"Inter-university AI programme","organisation":"Charles University & Czech Technical University","highlights":["Mathematical logic in AI","AI-assisted scientific workflows","AI in scientific inquiry"]}),
  N("credentials","credential","Credentials","education","education/credentials",null,"AI coursework certificates and Cambridge English B2 First.",{"layoutOrder":4,"highlights":["Ethics of AI","Introduction to Artificial Intelligence","Cambridge English B2 First - Score 170"]}),
  ...
  P("bachelor-thesis",6,"BSc Thesis","Bachelor Thesis - Quantum Logic & A-ROL","Academic research","Bachelor thesis on quantum logic and associative residuated ortholattices, with a focus on algebraic structure and related varieties.",["logic","research"],["academic"],{"orientation":["theoretical"],"collaboration":["individual"],"format":["thesis"],"status":"finished","visibility":"public"},["Algebraic logic","Universal algebra","Lattice theory","LaTeX"],"Successfully defended in 2026.",[{"label":"Thesis PDF ↗","href":"assets/documents/education/coursework/thesis.pdf"}],{"featuredRank":4,"caseStudy":{"oneLine":"Research on quantum logic, residuated ortholattices and the associative A-ROL fragment.","problem":"The project studies algebraic structures arising around quantum logic and the behaviour of their associative fragment.","role":"Author of the defended BSc thesis.","method":"Algebraic and lattice-theoretic analysis, literature synthesis, formal proofs and structured mathematical exposition.","result":"Successfully defended in 2026; the final thesis PDF is publicly available in the portfolio."}}),
  P("social-workers-survey",7,"Survey Analysis","Survey Analysis and Open-Text Coding","Applied research · Data analysis","End-to-end survey research covering data cleaning and validation, descriptive analysis, benchmarking, analysis of vignette responses and qualitative coding of open responses, with reproducible reports, visualisations and an interactive open-text explorer.",["computing-data","research"],["professional"],{"orientation":["empirical","applied"],"collaboration":["team"],"format":["analysis","pipeline"],"status":"active","visibility":"private"},["Python","pandas","Survey analysis","Statistics","Data visualisation","Open-text coding","Data QA"],"Private analytical repository and internal materials.",[],{"featuredRank":2,"caseStudy":{"oneLine":"Applied survey analysis combining data QA, quantitative summaries, visualisation, interpretation and structured coding of open responses.","problem":"Research data required cleaning, validation, analysis and a defensible way to turn open-text responses into structured evidence.","role":"Data analysis and open-text coding within a team research context.","method":"Cleaning and validation, descriptive analysis, benchmarking, analysis of vignette responses, qualitative codebook construction, visualisation, interpretation of results and reproducible reporting.","result":"Internal analytical outputs, reproducible reports, visualisations and an interactive open-text exploration workflow. Underlying materials remain private."}}),
...
window.SITE_DATA.semantics={
  ...
  education:{
    ...
    courseEvidence:[
      ...
      {id:"bsc-mathematics",title:"Mathematics & algebra",programmeId:"charles-university",status:"completed",description:"Mathematical foundations supporting logic, especially set theory, number theory, algebraic structures and lattice-theoretic methods.",courses:["Seminar in Mathematics","Introduction to Mathematics","Úvod do teorie financí","Set Theory I","Arithmetic and Algorithms","Algebra and Structures in Logic","Selected Topics in Mathematics","Number Theory Seminar","Model Theory","Lattice Theory","Quantum Physics"],supportsKnowledgeIds:["set-theory","number-theory","universal-algebra","lattice-theory"]},
      ...
      {id:"bsc-ai-philosophy",title:"AI & philosophy",programmeId:"charles-university",status:"completed",description:"Conceptual work around AI, cognition, logic and mathematics, combined with introductory AI coursework and analytic philosophy.",courses:["AI in Context","Elements of AI+","Ethics of AI+","AI and Philosophy","AI and Cognition","Can Machines Think?","Philosophical Aspects of Logic and Mathematics","Analytic Philosophy I","Analytic Philosophy II","What Cannot Be Spoken About"],supportsKnowledgeIds:["ai-methods","philosophy-ai"]}
    ],
    prgAiBlocks:[
