(() => {
  ...
  ensureStylesheet('portfolio-refinements.css?v=20260922-headergraph5', 'data-profile-refinements-style');
  ...
  ensureScript('profile-root.js?v=20260922-headergraph5', 'data-profile-root-overview');
