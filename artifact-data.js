(() => {
  ...
  const records = [
    ...
    },
    {
      ...
      anchorNodeIds: ['project-clp-survey', 'lattice-theory'],
    ...
    },
    {
      ...
      anchorNodeIds: ['project-bachelor-thesis', 'quantum-logic-arol', 'residuated-ortholattices-arol'],
    ...
    },
    {
      ...
      source: {
        kind: 'local',
        path: 'assets/images/about/woodworking/terasa.webp',
        fallbackPath: 'assets/images/about/woodworking/terasa.jpg'
      },
      mediaType: 'image/webp',
      availability: 'public',
      presentation: { preferredObject: 'image', role: 'project-photo', width: 2000, height: 1500, aspectRatio: 1.333333 }
    },
    {
    ...
    },
    {
      ...
      source: {
        kind: 'local',
        path: 'assets/video/work/axiom-wilds/demo-gameplay.web.mp4',
        fallbackPath: 'assets/video/work/axiom-wilds/demo-gameplay.mp4'
      },
      mediaType: 'video/mp4',
      availability: 'public',
