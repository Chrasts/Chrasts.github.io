...
window.SITE_DATA={
  ...
  N("metalogic-amalgamation-interpolation","education","Amalgamation & Interpolation","selected-coursework","education/charles-university/coursework/amalgamation-interpolation",null,"A short metalogic note on the relationship between amalgamation and interpolation in equational theories.",{"meta":"Metalogic note","layoutOrder":1,"detailLabel":"Amalgamation & Interpolation in Equational Theories"}),
  N("clp-historical-survey-coursework","education","CLP Historical Survey","selected-coursework","education/charles-university/coursework/clp-historical-survey",null,"A historical survey of the Congruence Lattice Problem, focused on the main milestones, ideas and developments in lattice theory.",{"meta":"Course paper","layoutOrder":2,"detailLabel":"The Congruence Lattice Problem — Historical Survey"}),
  N("simulation-credence-coursework","education","Simulation Credence","selected-coursework","education/charles-university/coursework/simulation-credence",null,"A course paper formalising credence in the simulation hypothesis and examining its consequences.",{"meta":"Course paper","layoutOrder":3,"detailLabel":"Simulation Credence and Its Consequences"}),
  N("bachelor-thesis-education","education","Bachelor Thesis","charles-university","education/charles-university/thesis","completed","Defended bachelor thesis on residuated ortholattices and their associative fragment in quantum logic.",{"meta":"Defended 2026","layoutOrder":2,"detailLabel":"Residuated Ortholattices and their Associative Fragment in Quantum Logic"}),
  N("charles-university-masters-logic","education","Master's in Logic","education","education/charles-university-masters-logic","ongoing","Ongoing follow-up Master's degree in Logic at Charles University.",{"meta":"2026 - present · ongoing","layoutOrder":2,"programme":"Master's degree in Logic","organisation":"Charles University","detailLabel":"Master's Degree in Logic"}),
  ...
  N("prg-ai","education","prg.ai Minor","education","education/prg-ai",null,"Inter-university AI programme across Charles University and Czech Technical University.",{"meta":"2026/27","layoutOrder":4,"programme":"Inter-university AI minor","organisation":"Charles University & Czech Technical University","highlights":["AI coursework across institutions","Programming, data analysis and AI methods"]}),
  N("credentials","credential","Certifications","education","education/credentials",null,"AI coursework certificates and Cambridge English B2 First.",{"layoutOrder":5,"highlights":["Ethics of AI","Introduction to Artificial Intelligence","Cambridge English B2 First — Score 170"]}),
  ...
  {"source":"clp-historical-survey-coursework","target":"congruence-lattice-problem","type":"related","secondary":true},
  {"source":"clp-historical-survey-coursework","target":"scientific-writing","type":"related","secondary":true},
