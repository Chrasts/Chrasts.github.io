(() => {
  ...
  // Final, single global compass. There is no intermediate fan in the runtime.
  ...
  const atlasPositions = () => {
    ...
    // Viewport-safe final projection. The slight vertical compression is deliberate:
    // it keeps the upper About/Education territories on screen and gives the Atlas
    // the wider silhouette requested for the global map.
    let maxDx = 1;
    let maxDy = 1;
