...
window.SITE_DATA.semantics={
  ...
  education:{
    ...
    courseEvidence:[
      ...
      {id:"bsc-mathematics",title:"Mathematics & algebra",programmeId:"charles-university",status:"completed",description:"Mathematical foundations supporting logic, especially set theory, number theory, algebraic structures and lattice-theoretic methods.",courses:["Seminar in Mathematics","Introduction to Mathematics","Set Theory I","Arithmetic and Algorithms","Algebra and Structures in Logic","Selected Topics in Mathematics","Number Theory Seminar","Mathematical Problems for Non-mathematicians"],supportsKnowledgeIds:["set-theory","number-theory","universal-algebra","lattice-theory"]},
